...
4. When a visitor types more than 2 characters into "Puh nro., 4 viimeistä" (phone no., last 4), a 300 ms-debounced filter keeps rows whose `ownerPhoneNumber` _ends with_ the typed digits.
